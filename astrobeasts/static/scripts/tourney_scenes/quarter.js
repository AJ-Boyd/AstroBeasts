...
export class QuarterScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('boss', '/static/assets/Objects/boss1.png')
    }
    ...
    create() {
        ...
        const Wiz = this.add.image(575, 330, 'boss'); Wiz.setScale(.85);

        // Title
        let Title = this.add.text(150, 90, "Quarter-Finals\nPlayer vs Mr. Q");
