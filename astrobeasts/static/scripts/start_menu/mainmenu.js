...
export class MainMenuScene extends Phaser.Scene {
    ...
    init() {
       ...
       this.registry.set('shop_moves', [
        ...
        { key: 'skol', assets: 'Skol', assetAnim: "idle_Skol", name: 'Skol', rarity: 'Common', description: 'Balanced AstroBeast', quantity: 1, cost: 50, isSelected: false, maxHP: 1000, currentHP: 1000, maxExp: 1000, currentExp: 0, stats: [300, 250, 300, 300, 250], level: 1, isAlive: true },
        { key: 'tarkeel', assets: 'Tarkeel', assetAnim: "idle_Tarkeel", name: 'Tarkeel', rarity: 'Common', description: 'Bug AstroBeast', quantity: 1, cost: 50, isSelected: false, maxHP: 1000, currentHP: 1000, maxExp: 1000, currentExp: 0, stats: [194, 128, 448, 500, 130], level: 1, isAlive: true },
